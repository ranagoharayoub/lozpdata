...
import { build2Func } from "../redux/actions";
import { useHistory } from "react-router-dom";

const Build2 = ({ build2Func, build2 }) => {
	useEffect(() => {
		build2Func();
	}, [build2Func]);
...
export default connect(mapStatetoProps, mapDispatchtoProps)(Build2);
