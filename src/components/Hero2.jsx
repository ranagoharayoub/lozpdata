...
const Hero2 = ({ heading, description, img, heightEcom, icbImg }) => {
	return (
		<>
			{/* HEADER START */}
					...
					<div className="row">
						<div className="col-12 col-sm-9 mx-auto">
							...
							>
								...
								<div className="col-12 col-sm-8 mx-auto col-md-6">
									<img
										className={`${icbImg && "icbImg"}`}
										style={{ width: "100%" }}
										src={img}
										alt="icbImage"
									/>
